...
public class TCPCommunicator {
    /*java class which is used by TcpCommunication class to send message to os using json object and socket connection on tcp protocol*/
    ...
    public static  TCPWriterErrors writeToSocket(final JSONObject obj,Handler handle,Context context)
    {
        ...
        Runnable runnable = new Runnable() {
             /*creating a UI thread to send a messagee from user written in activity to the os*/
    ...
    {
         /*creating listeners which are interfaces which run in background over a small period a display received message in the app*/
        allListeners.clear();
